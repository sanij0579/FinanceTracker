...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-uic9-r&5zye@etr&&!jtp3j%4g%2ypqp!5%u!v0tz!c1ha@(k1')
...
# Database (will use PostgreSQL on Render, SQLite locally)
DATABASES = {
